...
var CACHE = 'ga-pwa-v217';
var ASSETS = ['./', './index.html', './css/estilos.css',   './js/gagraf.js', './js/analisis.js', './js/arranque.js', './js/brokers.js', './js/buscador.js', './js/calor.js', './js/config.js', './js/graficos.js', './js/ia.js', './js/nucleo.js', './js/paneles.js', './js/seguridad.js', './js/sincronizar.js', './js/tablero.js', './js/trade.js', './js/bancos.js', './js/vistas.js', './js/watchlist.js',
  './manifest.json'];
